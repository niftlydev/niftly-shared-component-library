...
describe('TypeScript Preset', function () {
    ...
    it('should return compilerPath from getDynamicConfig function', function () {
        const preset = react_preset_1.reactPreset.getDynamicConfig ? react_preset_1.reactPreset.getDynamicConfig() : {};
    ...
    it('should override compiledFileTypes in getDynamicConfig function', function () {
        const preset = react_preset_1.reactPreset.getDynamicConfig ? react_preset_1.reactPreset.getDynamicConfig({ compiledFileTypes: ['.tsx'] }) : {};
    ...
    it('should override compilerArguments in getDynamicConfig function', function () {
        const preset = react_preset_1.reactPreset.getDynamicConfig ? react_preset_1.reactPreset.getDynamicConfig({ compilerArguments: [] }) : {};
        chai_1.expect(preset.compilerArguments).to.eql([]);
    });
    it('should set development to true', function () {
        const preset = react_preset_1.reactPreset.getDynamicConfig ? react_preset_1.reactPreset.getDynamicConfig({ development: true }) : {};
        chai_1.expect(preset.development).to.be.true;
    });
    it('should set development to false', function () {
        const preset = react_preset_1.reactPreset.getDynamicConfig ? react_preset_1.reactPreset.getDynamicConfig({ development: false }) : {};
